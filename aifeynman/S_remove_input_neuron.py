...
def remove_input_neuron(net, device, n_inp, idx_neuron, ct_median, save_filename):
    ...
    net.linear1.bias = nn.Parameter(net.linear1.bias+torch.tensor(ct_median*removed_weights).float().to(device))
